...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Gabby Davidson.
...
def main():
    ...
    #better_draw_circles(rg.Point(-300, 30), 20)
    #better_draw_circles(rg.Point(100,50), 6)
    even_better_draw_circles(rg.Point(100,90), 12, 17, 'green', 6)
    even_better_draw_circles(rg.Point(-300, 10), 5, 9, 'magenta', 4)
    even_better_draw_circles(rg.Point(-50,300), 5, 6, 'yellow', 1)
    even_better_draw_circles(rg.Point(50, -200), 20, 13, 'red', 10)
    window.update()
...
def even_better_draw_circles(point, radius, k, color, thickness):
    turtle = rg.SimpleTurtle()
    turtle.pen_up()
    turtle.go_to(point)
